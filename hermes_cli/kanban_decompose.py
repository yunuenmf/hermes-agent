...
def decompose_task(
    ...
    *,
    ...
    """
    # sqlite3.Connection's context manager does not close the descriptor;
    # use connect_closing so gateway auto-decompose sweeps do not leak
    # kanban.db/WAL/SHM handles in long-lived gateway processes.
